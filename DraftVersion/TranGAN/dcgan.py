...
class DCGAN():
    ...
    def train(self, epochs, batch_size=128, save_interval=50):
        ...
        self.generator.save(
            'models/dcgan%s_%d.h5' % (data_name,epochs))
        self.discriminator.save(
            'models/dcgan_D%s_%d.h5' % (data_name, epochs))
        print('\n')
    ...
    def save_imgs(self, epoch):
        ...
        for i in range(r):
            for j in range(c):
                ...
                axs[i,j].axis('off')
                cnt += 1
        fig_name = "images/%s_%d.png" % (data_name, epoch)
...
if __name__ == '__main__':
    ...
    for n in name:
        dcgan = DCGAN()
        data_name = n
        dcgan.train(epochs=50001, batch_size=64, save_interval=10000)
        del dcgan
