...
class GAN():
    ...
    def train(self, epochs, batch_size=128, sample_interval=50):
        ...
        for epoch in range(epochs):
            ...
            # Plot the progress
            sys.stdout.write ("\r%d [D loss: %f, acc.: %.2f%%] [G loss: %f]" % (epoch, d_loss[0], 100*d_loss[1], g_loss))
	    sys.stdout.flush()
	...
	self.generator.save(
            'models/gan%s_%d.h5' % (data_name, epochs))
        print('\n')
...
if __name__ == '__main__':
    gan = GAN()
    gan.train(epochs=2000, batch_size=8, sample_interval=500)
