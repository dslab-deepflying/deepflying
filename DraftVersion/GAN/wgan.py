...
class WGAN():
    ...
    def build_generator(self):
        ...
        d1_width = int(IMG_ROWS / 4)
        d1_height = int(IMG_COLS / 4)
    ...
    def train(self, epochs, batch_size=128, sample_interval=50):
        ...
        for epoch in range(epochs):
            ...
            # Plot the progress
            sys.stdout.write("%d [D loss: %f] [G loss: %f]" % (epoch, 1 - d_loss[0], 1 - g_loss[0]))
	    sys.stdout.flush()
        ...
        self.generator.save(
            'models/wgan%s_%d.h5' % (data_name, epochs))
    ...
    def sample_images(self, epoch):
        ...
        for i in range(r):
            for j in range(c):
                ...
                axs[i, j].axis('off')
                cnt += 1
        fig_name = "images/wgan%s_%d.png" % (data_name, epoch)
...
if __name__ == '__main__':
    wgan = WGAN()
    wgan.train(epochs=501, batch_size=32, sample_interval=50)
