...
class DCGAN():
    def __init__(self):
        ...
        self.decoder.compile(loss='binary_crossentropy', optimizer=optimizer)
    ...
    def train(self, epochs, batch_size=128, save_interval=50):
        ...
        for epoch in range(epochs):
            ...
            #  Train Decoder
            # ---------------------
            self.decoder.train_on_batch(gen_imgs,noise)
        ...
        self.generator.save(
            'models/dcgan_G_%s_%d.h5' % (data_name, epochs))
        self.discriminator.save(
            'models/dcgan_D_%s_%d.h5' % (data_name, epochs))
        self.decoder.save(
            'models/dcgan_De_%s_%d.h5' % (data_name, epochs))
        print('\n')
...
if __name__ == '__main__':
    dcgan = DCGAN()
    dcgan.train(epochs=11, batch_size=2, save_interval=10)
